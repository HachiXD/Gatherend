...
const SECTION_TITLE_CLASS =
  "border-b border-theme-border -mt-2.5 pb-0 text-base font-semibold  tracking-[0.06em] text-theme-text-muted";
const READ_ONLY_FIELD_CLASS =
  "flex h-8 items-center rounded-lg border border-theme-border-subtle bg-theme-bg-edit-form/35 px-3 text-[14px] text-theme-text-light";
const ACTION_LINK_CLASS =
  "inline-flex mt-1 h-6.5 min-w-[120px] items-center justify-center rounded-lg bg-theme-tab-button-bg px-3 text-[14px] text-theme-text-light transition hover:bg-theme-tab-button-hover";
        ...
        <section className={PANEL_SHELL_CLASS}>
          ...
          <div className="mt-2.5 space-y-2 -mb-1.5">
            <div className="space-y-0.5">
              <p className="text-[12px] font-semibold uppercase tracking-[0.06em] text-theme-text-muted">
                Nombre de Usuario
              </p>

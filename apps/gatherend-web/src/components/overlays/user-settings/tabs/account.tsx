...
const READ_ONLY_FIELD_CLASS =
 "flex h-8 items-center rounded-lg border border-theme-border-subtle bg-theme-bg-edit-form/35 px-3 text-[13px] text-theme-text-light";
const ACTION_LINK_CLASS =
 "inline-flex h-6.5 min-w-[120px] items-center justify-center rounded-lg bg-theme-tab-button-bg px-3 text-[14px] text-theme-text-light transition hover:bg-theme-tab-button-hover";

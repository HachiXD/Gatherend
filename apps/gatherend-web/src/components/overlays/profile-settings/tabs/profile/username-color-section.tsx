...
const panelToggleButtonClass =
 "h-6.5 cursor-pointer rounded-lg border px-3 text-[13px] transition";
...
export const UsernameColorSection = memo(function UsernameColorSection({
 ...
 <div className="space-y-2 rounded-lg border border-theme-border bg-theme-bg-primary/70 px-3 py-2">
 ...
 Clickea la barra para agregar colores y arrástralos para cambiar
 su posición.
 </p>
 </div>
 </div>
 ...
 {selectedColor && (
 <div className="space-y-1 rounded-lg border border-theme-border bg-theme-bg-primary/70 p-2">
 <div className="flex items-center justify-between gap-2 -mt-1">
 <span className="text-[11px] font-semibold uppercase tracking-[0.05em] text-theme-text-subtle">
 Selected Color
 </span>
 <span className="rounded-lg border border-theme-border bg-theme-bg-primary/70 px-2 py-0 text-[11px] text-theme-text-muted">
 ...
 disabled={isSaving}
 className="h-8 w-8 mr-1 cursor-pointer rounded-lg border border-theme-channel-type-inactive-border bg-theme-channel-type-inactive-bg hover:bg-theme-channel-type-inactive-bg p-0 text-theme-channel-type-inactive-text hover:border-theme-channel-type-inactive-hover-border hover:text-red-400"
 >
 <X className="w-3 h-3" />
 </Button>
 )}
 ...
 <div className="space-y-0 rounded-lg border border-theme-border bg-theme-bg-primary/70 p-2">
 <div className="flex items-center justify-between gap-2 -mt-1">
 <label
 ...
 <span className="rounded-lg border border-theme-border bg-theme-bg-primary/70 px-2 py-0.5 text-[11px] text-theme-text-muted">
 ...
 className="h-2 w-full cursor-pointer appearance-none rounded-lg bg-theme-bg-primary/70 accent-theme-accent-primary"
 disabled={isSaving}

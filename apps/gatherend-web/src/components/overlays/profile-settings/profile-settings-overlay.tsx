...
function SettingsOverlaySkeleton() {
 return (
  ...
  <div className="h-8 w-full animate-pulse rounded-lg border border-white/8 bg-white/5" />
  <div className="h-8 w-2/3 animate-pulse rounded-lg border border-white/8 bg-white/5" />
  </div>
 );
}

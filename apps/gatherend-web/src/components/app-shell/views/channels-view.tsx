      ...
      <div className="h-full w-full overflow-y-auto scrollbar-chat">
        <div className="sticky top-0 z-20 shrink-0 border-b border-theme-border transition-colors duration-300">
          ...
          >
            <div className="ml-3 mr-3 flex items-center gap-2">
              <div className="flex min-w-0 max-w-[min(58vw,520px)] items-center justify-center gap-2 rounded-lg px-3 py-0.5">
                <MessagesSquare className="h-6 w-6 shrink-0 text-theme-text-subtle" />
        ...
        <div className="px-4 py-4 ">
          <div className="mx-auto w-full max-w-5xl">
            <div className="border rounded-lg border-theme-border bg-theme-bg-overlay-primary/78 p-3">

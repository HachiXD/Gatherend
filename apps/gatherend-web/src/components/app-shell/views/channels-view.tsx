      ...
      <div className="h-full w-full overflow-y-auto scrollbar-chat">
        <div className="sticky top-0 z-20 shrink-0 border-b border-theme-border transition-colors duration-300">
          <div className="px-0 pt-2.5 pb-2.5" style={headerButtonStyles}>
            <div className="ml-3 mr-3 flex items-center gap-2">
              <div className="flex min-w-0 max-w-[min(58vw,520px)] items-center justify-center gap-2 bg-(--community-header-btn-bg) px-3 py-0.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.16),inset_-1px_0_0_rgba(255,255,255,0.16),inset_1px_0_0_rgba(0,0,0,0.38),inset_0_-1px_0_rgba(0,0,0,0.38)]">
                <MessagesSquare className="h-4 w-4 shrink-0 text-(--community-header-btn-muted)" />
              ...
              <span className="ml-1 shrink-0 text-[13px] text-(--community-header-btn-muted)">
                ...
                {board?.channels.length === 1 ? "chat" : "chats"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 py-4 md:px-6">
          <div className="mx-auto w-full max-w-5xl">
            <div className="border border-theme-border bg-theme-bg-overlay-primary/78 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-1px_0_rgba(0,0,0,0.26)]">
              <LeftbarClient
                boardId={boardId}
                role={role}
